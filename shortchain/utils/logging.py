"""Structured logging for ShortChain.
...
def setup_file_logging(
    ...
    """Add a file handler to the root ``shortchain`` logger.

    Useful for persisting full debug output during long pipeline runs.
    """
    root = logging.getLogger("shortchain")
...
#   from shortchain.utils.logging import log
log = get_logger("shortchain")
