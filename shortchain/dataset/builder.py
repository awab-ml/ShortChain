...
The v2 (current) pipeline upgrades:
...
class DatasetBuilder:
    ...
    def build_candidates(
        ...
        the caller (e.g. the app-scoped tool catalog) rather than generated by
        the negative sampler. No negatives are sampled here — every candidate is
