...
from tabagent.config import TabAgentConfig
...
ADAPTERS: dict[str, str] = {
    "toolbench": "tabagent.benchmarks.toolbench:ToolBenchAdapter",
    # Future:
    # "apibank":   "tabagent.benchmarks.apibank:APIBankAdapter",
    # "gorilla":   "tabagent.benchmarks.gorilla:GorillaAdapter",
    # "webarena":  "tabagent.benchmarks.webarena:WebArenaAdapter",
}
...
def create_adapter(name: str, config: TabAgentConfig, **kwargs: Any) -> BenchmarkAdapter:
    ...
    config
        Root TabAgent configuration.  The adapter receives the relevant
